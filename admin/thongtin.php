                                    ...
                                    <?php while ($row = $result->fetch_assoc()) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="autoload/autoload_thongtin.php?id=<?= $row['MaLH'] ?>" class="btn btn-danger btn-sm"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="autoload/autoload_thongtin.php" method="POST">
                        <input type="hidden" id="malh" name="malh">
                        <div class="mb-3">
                            <label for="tensp" class="form-label">Mã người dùng</label>
                            <input type="text" class="form-control" id="mand" name="mand" required>
                        </div>
                        <div class="mb-3">
                            <label for="hinhanh" class="form-label">Số điện thoại</label>
                            <input type="text" class="form-control" id="sdt" name="sdt" required>
                        </div>
                        <div class="mb-3">
                            <label for="dongia" class="form-label">Email</label>
                            <input type="text" class="form-control" id="email" name="email" required>
                        </div>
                        <div class="mb-3">
                            <label for="soluong" class="form-label">Địa chỉ</label>
